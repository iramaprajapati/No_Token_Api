...
class _ProductPageState extends State<ProductPage> {
             ...
             Container(
               ...
               child: Card(
                 ...
                 child: Column(
                   children: [
                     Text('0'),
                     Text('${mapData['view_biography'][0]['title'].toString()}'),
              ...
              ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        STM().redirect2page(context, ProductDetails(data: v[index],));
                      },
                      child: Container(
  ...
  void postApi() async {
    ...
    var result = await STM().post(ctx, Str().updating, "view_biography", body,);
    setState(() {
      mapData = result;
      print(result);
    });
